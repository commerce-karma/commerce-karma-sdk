 ...
 */
export declare function findRating({ id, paymentEase, workEase, wouldRefer, overall, text, customer, createdBy, createdAt, updatedAt, archivedAt }: FindRatingParams): Promise<Rating[]>;
